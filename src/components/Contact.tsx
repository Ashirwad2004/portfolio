            ...
            <div className="glass-card rounded-2xl p-6 md:p-8 border border-zinc-850">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <AnimatePresence mode="wait">
                  {status === "success" && (
                    ...
                    >
                      ...
                      <div>
                        <p className="font-semibold text-white">Message Shipped Successfully!</p>
                        <p className="mt-0.5 text-zinc-400">Thank you. I'll get back to you within 24 business hours.</p>
                      </div>
                    </motion.div>
                  )}
                  {status === "error" && (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="mt-0.5 text-zinc-400">Please fill out all form inputs correctly before submission.</p>
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>
                ...
                >
                  ...
                  <span>{status === "submitting" ? "Transmission in Progress..." : "Send Message"}</span>
                </button>
